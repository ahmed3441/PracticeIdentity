...
{
    /// <inheritdoc />
    public partial class hotelEntitiesAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeMobileNo = table.Column<int>(type: "int", nullable: false),
                    EmploeeGender = table.Column<string>(type: "nvarchar(6)", nullable: false),
                    EmployeeEmailId = table.Column<string>(type: "nvarchar(250)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomNo = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    RoomType = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    Bed = table.Column<string>(type: "nvarchar(250)", nullable: false),
